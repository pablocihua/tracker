...
import * as import0 from '../../../src/directives/ng-file-select';
import * as import1 from '@angular/core/src/change_detection/change_detection';
import * as import2 from '@angular/core/src/linker/view';
import * as import3 from '@angular/core/src/linker/view_utils';
export class Wrapper_NgFileSelectDirective {
  /*private*/ _eventHandler:Function;
  context:import0.NgFileSelectDirective;
  ...
  constructor(p0:any) {
    this._changed = false;
    this.context = new import0.NgFileSelectDirective(p0);
  ...
  subscribe(view:import2.AppView<any>,_eventHandler:any,emit0:boolean,emit1:boolean,emit2:boolean,emit3:boolean):void {
    ...
    if (emit2) { (this.subscription2 = this.context.onUploadRejected.subscribe(_eventHandler.bind(view,'onUploadRejected'))); }
    if (emit3) { (this.subscription3 = this.context.beforeUpload.subscribe(_eventHandler.bind(view,'beforeUpload'))); }
  }
}